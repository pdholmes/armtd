...
test_k = [-pi/3; pi/25; -pi/25; pi/25; pi/25; pi/3];
...
for i = 10:10:50
    ...
    for i = 1:6
        O1{i} = make_orientation(q1(i), rotation_axes(i));
        O2{i} = make_orientation(q2(i), rotation_axes(i));
    end
...
%.... i'm gonna call that close enough!! probably just a mismatch between the 
% 