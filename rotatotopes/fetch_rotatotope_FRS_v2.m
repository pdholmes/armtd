classdef fetch_rotatotope_FRS_v2 < robot_rotatotope_FRS_v2
    ...
    methods
        function obj = fetch_rotatotope_FRS_v2(q_0, q_dot_0, FRS_options, varargin)
            ...
            n_base = [1]; % number of "base links", not used for collision constraints but affect FRS construction
            ...
            link_zonotopes = {zonotope([0.3556/2, 0.3556/2; 0, 0; 0, 0]);...
                              zonotope([0.3302/2, 0.3302/2; 0, 0; 0, 0]);...
                              zonotope([0.3302/2, 0.3302/2; 0, 0; 0, 0])}; % zonotopes representing the volume of each link
            joint_zonotopes = {zonotope([0.3556; 0; 0]);...
                               zonotope([0.3302; 0; 0]);...
                               zonotope([0.3302; 0; 0])}; % zonotopes representing volume of joints at end of each link
            base_predecessor_joints = {[1]}; % joints that precede base "link"... base link not used for collision detection, but affects FRS construction
            base_joint_zonotopes = {zonotope([0.1206; 0; 0.0825])}; % represents "shoulder" base link of Fetch
